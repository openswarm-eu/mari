...
#define MIRA_PACKET_QUEUE_SIZE (32) // must be a power of 2

#define MIRA_AUTO_UPLINK_KEEPALIVE 1 // whether to send a keepalive packet when there is nothing to send
