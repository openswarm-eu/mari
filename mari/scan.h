...
#define MARI_HANDOVER_RSSI_HYSTERESIS (12)               // hysteresis (in dBm) for handover
#define MARI_HANDOVER_MIN_INTERVAL    (1000 * 1000 * 3)  // minimum interval between handovers (in us)
