...
uint64_t nodes[NODES_MAX] = { 0x66b6ce28d5f79f9d, 0x7e3e2fa977053dbd, 0xa9464aa41e476850, 0xc3392ba31b942960, 
...
bool bl_scheduler_node_bloom_contains(uint64_t node_id, const uint8_t *bloom) {
...
int main(void) {
    ...
    bl_scheduler_gateway_gen_bloom_from_list(nodes, NODES_LEN, bloom);
